...
<title>Has sido eliminado</title>
...
<body data-spy="scroll" data-target="#navbar" data-offset="74">
	...
	<!-- Main -->
	<section id="winner" class="mt-4 mb-4 fondo-magenta">
      <div class="container  ">
        <div class="row col-8 offset-2 mt-3 centrado">
          <div class="col text-center mt-3 mb-3  ">
            <h2 class=" sin-fondo ">Lo sentimos !! <br>Has sido eliminado de <i>The Challenge</i></h2>
          </div>
        </div>
        <div class="row centrado ">
          <div class="col-lg-4 ">
          	<img class="card-img-top mb-5" src="images/gameOver.jpg" alt="Has sido eliminado"/>
          </div>
			<div class="col-lg-4">
							<div class="row centrado">
			<div class="col-lg-10 mt-5 pt-3 ">
        		<a class="btn btn-verde-claro btn-block offset-2" href="createOrSelect.jsp">Volver a jugar</a>
        	</div>
			</div>
										<div class="row centrado">
			<div class="col-lg-10 mt-5 pt-5 ">
        		<a class="btn btn-blue btn-block offset-2" href="index.jsp">Desconectar</a>
        	</div>
			</div>
			</div>
