...
<body data-spy="scroll" data-target="#navbar" data-offset="74">
    ...
    <nav id="header" class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      <div class="container">
        ...
        <%--Bienvenido (invitado) y boton Salir --%>
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav ml-auto">
              <li class="mt-2 mr-5">
                <p class="designed-by">Bienvenido/a, <b>Invitado/a</b></p>
              </li>
      ...
      <div class="container  ">
        <div class="row col-8 offset-2 mt-3">
          <div class="col text-center mt-3 mb-3  ">
            ...
            <h2 class="pb-2 sin-fondo ">Elige un avatar</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top" src="images/batman.jpg" alt="avatar 1"/>
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
          ...
          <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-5 mb-5 pb-1" src="images/cibernetica.jpg" alt="avatar 2">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top" src="images/spiderman.jpg" alt="avatar 3">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top" src="images/superman.jpg" alt="avatar 4">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-4 mb-3 pb-2" src="images/thor.png" alt="avatar 5">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-5 mb-5 pb-1" src="images/wonderWoman.jpg" alt="avatar 6">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
