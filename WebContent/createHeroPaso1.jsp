...
<section id="personajes" class="mt-4 mb-4 fondo-verde-claro">
      <div class="container  ">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-5 mb-5 pb-1" src="images/cibernetica.jpg" alt="Capitán América">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top" src="images/spiderman.jpg" alt="Capitán América">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="cargarPartida.jsp">
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-4 mb-3 pb-2" src="images/thor.png" alt="Capitán América">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-4">
            <div class="card">
              <img class="card-img-top mt-5 mb-5 pb-1" src="images/wonderWoman.jpg" alt="Capitán América">
              <div class="card-body">
                <form action="cargarPartida.jsp">
                	<div class="centrado">
                		<input class="  btn btn-blue  mb-2 " type="submit" name="hero" value="Seleccionar" />
